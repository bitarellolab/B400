...
* Mac: In your personal or lab computer (if Linux or Mac), go to the "Terminal" application. Tip: if you don't know where to find it, open Finder and search for it. 

* Windows: if you have never used a command line, just use the one I am providing here in this space. Click on the "terminal" icon on the bottom left.
