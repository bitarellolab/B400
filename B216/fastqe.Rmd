...
subtitle: "Developed by: Ray Enke, Rachael St. Jaques1, Max Maza, Caylin Murray, Sabrina Robertson, Andrew Lonsdale, & Jason Williams"
output:
  html_document:
    df_print: paged
---
...
For example, running the next cell executes the pwd (print working directory) command, which will tell you what directory this notebook is located in.
